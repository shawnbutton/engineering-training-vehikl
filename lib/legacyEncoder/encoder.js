...
const encodePipeQueryString = params => {
  ...
  for (const param in params) {
    ...
    if (isNaN(params[param])) {
      queryString += inQuotes(params[param])
    } else {
      queryString += addComma(params[param])
    }
  }
...
const encodePipeRepairQueryString = params => {
  ...
  // add encoded braces
  queryString = addBraces(queryString)
  return queryString
}
...
const encodeMeasurementQueryString = params => {
  ...
  // add encoded braces
  return addBraces(encodeURIComponent(queryString))
}
...
const encodeCorrelationQueryString = params => {
  ...
  // add encoded braces
  queryString = addBraces(encodeURIComponent(queryString))
  return queryString
}
