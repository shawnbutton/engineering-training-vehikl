...
const encodeSegmentQueryString = object => {
  return addBraces(encodeQuery(object, ['apikey'], ['sid', 'nid', 'pid', 'sqi']))
}
...
const encodePipeRepairQueryString = params => {
  return addBraces(encodeQuery(params, ['apikey'], ['sid', 'pid', 'poi']))
}

const encodeSpectrumRepairQueryString = object => {
  return addBraces(encodeQuery(object, ['apikey']))
}
...
const encodeMeasurementQueryString = params => {
  return addBraces(encodeURIComponent(encodeQuery(params, ['apikey'], ['sid', 'nid', 'mt', 'sc', 'max'])))
}

const encodeMeasurementCsvQueryString = params => {
  return addBraces(encodeURIComponent(encodeQuery(params, ['apikey'], ['sid', 'nid', 'mt'])))
}
